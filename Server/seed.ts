...
const restuarantdata = [
    ...
    console.log("inserting restuarent...")
    const updatedrestuarant = restuarantdata.map((rest , idx)=>{
        const {...restInfo} = rest ;
        return {
            ...restInfo ,
            owner:owneruser._id,
    ...
    await Restuarent.insertMany(updatedrestuarant)
    console.log("seeding processed...")
